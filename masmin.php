  ...
  <?php
	...
	//Checking is user existing in the database or not
        ...
        if($rows==1){
			...
			header("Location: dashmin.php"); // Redirect user to index.php
            }else{
				...
				<a href='masmin.php'>Klik Disini</a> Untuk Mencoba Kembali
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              ...
              <li class="nav-item">
                <a class="nav-link page-scroll" href="regmin.php">Buat Akun Baru</a>
              </li> 

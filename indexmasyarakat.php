      ...
      <div class="container">      
        <div class="row space-100">
          <div class="col-lg-6 col-md-12 col-xs-12">
            <div class="contents">
              <h2 class="head-title">Selamat Datang Di<br>Dashboard APPM</h2>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-xs-12">
              <div class="services-item text-center">
                ...
                <button onclick="window.location.href = 'buatlaporan.php';">Buat Laporan</button>
            </div>
            </div>
            <!-- End Col -->
            <!-- Start Col -->
            <div class="col-lg-4 col-md-6 col-xs-12">
              <div class="services-item text-center">
                ...
                <p>Lihat Tanggapan Yang Diberikan Oleh Petugas Mengenai Laporan Anda.</p>
                <button onclick="window.location.href = 'liattanggapan.php';">Lihat Tanggapan</button>

...
<html lang="en">
  ...
  <?php
	...
	//Checking is user existing in the database or not
        $query = "SELECT * FROM `masyarakat` WHERE username='$username' and password='".md5($password)."'";
		$result = mysqli_query($con,$query) or die(mysql_error());
		$rows = mysqli_num_rows($result);
        if($rows==1){
			$_SESSION['username'] = $username;
			header("Location: indexmasyarakat.php"); // Redirect user to index.php
            }else{
				...
				<a href='masuk.php'>Klik Disini</a> Untuk Mencoba Kembali
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              ...
              <li class="nav-item">
                <a class="nav-link page-scroll" href="registrasimasyarakat.php">Buat Akun Baru</a>
              </li> 
      ...
      <div class="container">      
        <div class="row space-100">
          <div class="col-lg-6 col-md-12 col-xs-12">
            <div class="contents">
              <h2 class="head-title">Silahkan Masuk</h2>

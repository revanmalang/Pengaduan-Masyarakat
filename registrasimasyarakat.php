...
<html lang="en">
  ...
  <?php
    ...
    if (isset($_REQUEST['nik'])){
        ...
        $telp = stripslashes($_REQUEST['telp']);
        $telp = mysqli_real_escape_string($con,$telp);
        
        $query = "INSERT into `masyarakat` (nik, nama, username, password, telp) VALUES ('$nik', '$nama', '$username', '".md5($password)."', '$telp')";
        $result = mysqli_query($con,$query);
        if($result){
          header ('location: yeay.html');
        }
        else
        {
          header ('location: yeay.html');
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              ...
              <li class="nav-item">
                <a class="nav-link page-scroll" href="tatacara.html">Tata Cara Pelaporan</a>
              </li>  
               
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#">Buat Akun Baru</a>
              </li> 
 <li class="nav-item">
                <a class="nav-link page-scroll" href="masuk.php">Masuk</a>
              </li> 
      ...
      <div class="container">      
        <div class="row space-100">
          <div class="col-lg-6 col-md-12 col-xs-12">
            <div class="contents">
              <h2 class="head-title">Selamat Datang Di<br>Aplikasi Pelaporan Pengaduan Masyarakat</h2>
          ...
          <div class="row">
            ...
            <form action="" method="post">
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <input type="text" class="form-control" id="telp" name="telp" placeholder="No Handphone" maxlength="13" required data-error="Silahkan Masukan No Handphone Anda">
                    <div class="help-block with-errors"></div>
                  </div>                                 
                </div>
                <div class="col-md-12">
